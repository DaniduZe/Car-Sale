        ...
        private void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand checkNIC = new SqlCommand("select NIC from Supplier", con);
                    SqlCommand checkTelephone = new SqlCommand("Select Telephone from Supplier", con);
                    SqlCommand checkEmail = new SqlCommand("Select Email from Supplier", con);

                    if (txt_Supplier_ID.Text.Equals(checkNIC.ExecuteNonQuery()) == true)
                    {
                        txt_error_Supplier_NIC.Text = "This NIC is already in use!";
                        txt_Supplier_ID.Focus();
                    }
                    else if (txt_Telephone.Text.Equals(checkTelephone.ExecuteNonQuery()) == true)
                    {
                        txt_error_Email.Text = "This Telephone already exists!";
                        txt_Email.Focus();
                    }
